...
export const navTabsLinkHoverBorderColor = format('{} {} {}', grays._200, grays._200, navTabsBorderColor)
export const navTabsLinkActiveColor = grays._700
export const navTabsLinkActiveBg = bodyBg
export const navTabsLinkActiveBorderColor = format('{} {} {}', grays._300, grays._300, navTabsLinkActiveBg)
...
export const navDividerMarginY = format('{}{}', size(spacer).value / 2, size(spacer).unit)
