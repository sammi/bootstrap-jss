...
describe('Dropdowns', () => {
  it('Dropdown menu container and contents.', () => {
    ...
    expect(dropdownBorderColor).toEqual(rgba(black, 0.15))
    ...
    expect(dropdownBoxShadow).toEqual(`0 .5rem 1rem ${rgba(black, 0.175)}`)

    expect(dropdownLinkColor).toEqual(grays._900)
    expect(dropdownLinkHoverColor).toEqual(darken(grays._900, '5%'))
