...
describe('Forms', () => {
    it('Forms', () => {
        ...
        expect(inputBoxShadow).toEqual(format('inset 0 1px 1px {}', rgba(black, .075)))
        ...
        expect(customControlIndicatorBoxShadow).toEqual(format('inset 0 .25rem .25rem {}', rgba(black, .1)))
        ...
        expect(customControlIndicatorCheckedDisabledBg).toEqual(format('{}', rgba(themeColors.primary, .5)))
        ...
        expect(customRangeTrackBoxShadow).toEqual(format('inset 0 .25rem .25rem {}', rgba(black, .1)))
        ...
        expect(customRangeThumbBoxShadow).toEqual(format('0 .1rem .25rem {}', rgba(black, .1)))
