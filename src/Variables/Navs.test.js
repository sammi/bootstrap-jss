...
describe('Navs', () => {
    ...
    it('Navs', () => {
        expect(navLinkPaddingY).toEqual('.5rem !default')
        expect(navLinkPaddingX).toEqual('1rem !default')
        ...
        expect(navTabsLinkHoverBorderColor).toEqual(format('{} {} {} !default', grays._200, grays._200, navTabsBorderColor))
        expect(navTabsLinkActiveColor).toEqual(grays._700)
        expect(navTabsLinkActiveBg).toEqual(bodyBg)
        expect(navTabsLinkActiveBorderColor).toEqual(format('{} {} {} !default', grays._300, grays._300, navTabsLinkActiveBg))
        ...
        expect(navDividerMarginY).toEqual(format('{}{} !default', size(spacer).value / 2, size(spacer).unit))
