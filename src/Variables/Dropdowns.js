...
export const dropdownBorderColor = rgba(black, 0.15)
...
export const dropdownBoxShadow = `0 .5rem 1rem ${rgba(black, 0.175)}`

export const dropdownLinkColor = grays._900
export const dropdownLinkHoverColor = darken(grays._900, '5%')
